...
use backend\models\VisitaSearch;
...
class EstablecimientoController extends Controller
{
    ...
    public function actionView($id)
    {
        ...
        $searchModelVisita = new VisitaSearch();
        $model = $this->findModel($id);
        $dataProviderVisita = $searchModelVisita->search(Yii::$app->request->queryParams,$id);
        
        return $this->render('view', [
            'model' => $this->findModel($id),
            'searchModelVisita'=> $searchModelVisita,
            'dataProviderVisita'=> $dataProviderVisita
        ]);
    }
